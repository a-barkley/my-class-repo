...
describe("DayCare", () => {
  describe("Initialization", () => {
    it("should create an object with 'children' array, 'capacity' number, and 'ageLimit' number", () => {
      ...
      // Tests if the daycare variable has the following properties
  ...
  describe("addChild", () => {
    it("should add a child to the 'children' array", () => {
      // Creating new objects for our test cases
      const child = new Child("Tammy", 1);
      const dayCare = new DayCare();

      // adds the new child object ot the daycare array
      dayCare.addChild(child);

      // Checks if there is only one child object in the daycare array, and if that child object is equal to the one made above

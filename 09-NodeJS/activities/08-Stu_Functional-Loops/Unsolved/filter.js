...
const isPrime = num => {
  // Set up a loop the starts with 2 and continues to increment i as long as i is less than num
  for (let i = 2; i < num; i++) {
...
// filter is only keeping values that are not false from the original array. 
